...
MEDIA_VIEWER_ACTION_SHOW_WITH_QMEDIAPLAYER_GRAPHICS_VIEW = 9
...
media_viewer_action_string_lookup = {
    ...
    MEDIA_VIEWER_ACTION_SHOW_WITH_QMEDIAPLAYER_VIDEO_WIDGET : 'show using Qt Media Player Test 1 - Video Widget (EXPERIMENTAL, buggy, crashy, always on top render!)',
    MEDIA_VIEWER_ACTION_SHOW_WITH_QMEDIAPLAYER_GRAPHICS_VIEW : 'show using Qt Media Player Test 2 - Graphics View (EXPERIMENTAL, mite b cool?)',
}
...
animated_media_actions = [ MEDIA_VIEWER_ACTION_SHOW_WITH_MPV, MEDIA_VIEWER_ACTION_SHOW_WITH_QMEDIAPLAYER_VIDEO_WIDGET, MEDIA_VIEWER_ACTION_SHOW_WITH_QMEDIAPLAYER_GRAPHICS_VIEW ] + static_media_actions
audio_media_actions = [ MEDIA_VIEWER_ACTION_SHOW_WITH_MPV, MEDIA_VIEWER_ACTION_SHOW_WITH_QMEDIAPLAYER_VIDEO_WIDGET, MEDIA_VIEWER_ACTION_SHOW_WITH_QMEDIAPLAYER_GRAPHICS_VIEW ] + unsupported_media_actions
...
class GlobalPixmaps( object ):
    ...
    def _reinitialise( self ):
        ...
        self.bold = QG.QPixmap( HydrusStaticDir.get_static_path( 'text_bold.png' ) )
        self.italic = QG.QPixmap( HydrusStaticDir.get_static_path( 'text_italic.png' ) )
        self.underline = QG.QPixmap( HydrusStaticDir.get_static_path( 'text_underline.png' ) )
        
        self.align_left = QG.QPixmap( HydrusStaticDir.get_static_path( 'text_align_left.png' ) )
        self.align_center = QG.QPixmap( HydrusStaticDir.get_static_path( 'text_align_center.png' ) )
        self.align_right = QG.QPixmap( HydrusStaticDir.get_static_path( 'text_align_right.png' ) )
        self.align_justify = QG.QPixmap( HydrusStaticDir.get_static_path( 'text_align_justify.png' ) )
        
        self.indent_less = QG.QPixmap( HydrusStaticDir.get_static_path( 'text_indent_remove.png' ) )
        self.indent_more = QG.QPixmap( HydrusStaticDir.get_static_path( 'text_indent.png' ) )
        
        self.font = QG.QPixmap( HydrusStaticDir.get_static_path( 'font.png' ) )
        self.colour = QG.QPixmap( HydrusStaticDir.get_static_path( 'color_swatch.png' ) )
        
        self.link = QG.QPixmap( HydrusStaticDir.get_static_path( 'link.png' ) )
        self.link_break = QG.QPixmap( HydrusStaticDir.get_static_path( 'link_break.png' ) )
        
        self.drag = QG.QPixmap( HydrusStaticDir.get_static_path( 'drag.png' ) )
        
        self.transparent = QG.QPixmap( HydrusStaticDir.get_static_path( 'transparent.png' ) )
        self.downloading = QG.QPixmap( HydrusStaticDir.get_static_path( 'downloading.png' ) )
        self.file_repository = QG.QPixmap( HydrusStaticDir.get_static_path( 'file_repository_small.png' ) )
        self.file_repository_pending = QG.QPixmap( HydrusStaticDir.get_static_path( 'file_repository_pending_small.png' ) )
        self.file_repository_petitioned = QG.QPixmap( HydrusStaticDir.get_static_path( 'file_repository_petitioned_small.png' ) )
        self.ipfs = QG.QPixmap( HydrusStaticDir.get_static_path( 'ipfs_small.png' ) )
        self.ipfs_pending = QG.QPixmap( HydrusStaticDir.get_static_path( 'ipfs_pending_small.png' ) )
        self.ipfs_petitioned = QG.QPixmap( HydrusStaticDir.get_static_path( 'ipfs_petitioned_small.png' ) )
        
        self.collection = QG.QPixmap( HydrusStaticDir.get_static_path( 'collection.png' ) )
        self.inbox = QG.QPixmap( HydrusStaticDir.get_static_path( 'inbox.png' ) )
        self.trash = QG.QPixmap( HydrusStaticDir.get_static_path( 'trash.png' ) )
        
        self.refresh = QG.QPixmap( HydrusStaticDir.get_static_path( 'refresh.png' ) )
        self.archive = QG.QPixmap( HydrusStaticDir.get_static_path( 'archive.png' ) )
        self.to_inbox = QG.QPixmap( HydrusStaticDir.get_static_path( 'to_inbox.png' ) )
        self.delete = QG.QPixmap( HydrusStaticDir.get_static_path( 'trash.png' ) )
        self.trash_delete = QG.QPixmap( HydrusStaticDir.get_static_path( 'delete.png' ) )
        self.undelete = QG.QPixmap( HydrusStaticDir.get_static_path( 'undelete.png' ) )
        self.zoom_in = QG.QPixmap( HydrusStaticDir.get_static_path( 'zoom_in.png' ) )
        self.zoom_out = QG.QPixmap( HydrusStaticDir.get_static_path( 'zoom_out.png' ) )
        self.zoom_switch = QG.QPixmap( HydrusStaticDir.get_static_path( 'zoom_switch.png' ) )
        self.zoom_cog = QG.QPixmap( HydrusStaticDir.get_static_path( 'zoom_cog.png' ) )
        self.eye = QG.QPixmap( HydrusStaticDir.get_static_path( 'eye.png' ) )
        self.fullscreen_switch = QG.QPixmap( HydrusStaticDir.get_static_path( 'fullscreen_switch.png' ) )
        self.open_externally = QG.QPixmap( HydrusStaticDir.get_static_path( 'open_externally.png' ) )
        self.move = QG.QPixmap( HydrusStaticDir.get_static_path( 'move.png' ) )
        self.move_cursor = QG.QPixmap( HydrusStaticDir.get_static_path( 'move32x.png' ) )
        
        self.dump_ok = QG.QPixmap( HydrusStaticDir.get_static_path( 'dump_ok.png' ) )
        self.dump_recoverable = QG.QPixmap( HydrusStaticDir.get_static_path( 'dump_recoverable.png' ) )
        self.dump_fail = QG.QPixmap( HydrusStaticDir.get_static_path( 'dump_fail.png' ) )
        
        self.cog = QG.QPixmap( HydrusStaticDir.get_static_path( 'cog.png' ) )
        self.family = QG.QPixmap( HydrusStaticDir.get_static_path( 'family.png' ) )
        self.keyboard = QG.QPixmap( HydrusStaticDir.get_static_path( 'keyboard.png' ) )
        self.help = QG.QPixmap( HydrusStaticDir.get_static_path( 'help.png' ) )
        
        self.check = QG.QPixmap( HydrusStaticDir.get_static_path( 'check.png' ) )
        self.pause = QG.QPixmap( HydrusStaticDir.get_static_path( 'pause.png' ) )
        self.play = QG.QPixmap( HydrusStaticDir.get_static_path( 'play.png' ) )
        self.stop = QG.QPixmap( HydrusStaticDir.get_static_path( 'stop.png' ) )
        
        self.sound = QG.QPixmap( HydrusStaticDir.get_static_path( 'sound.png' ) )
        self.mute = QG.QPixmap( HydrusStaticDir.get_static_path( 'mute.png' ) )
        
        self.notes = QG.QPixmap( HydrusStaticDir.get_static_path( 'notes.png' ) )
        
        self.file_pause = QG.QPixmap( HydrusStaticDir.get_static_path( 'file_pause.png' ) )
        self.file_play = QG.QPixmap( HydrusStaticDir.get_static_path( 'file_play.png' ) )
        self.gallery_pause = QG.QPixmap( HydrusStaticDir.get_static_path( 'gallery_pause.png' ) )
        self.gallery_play = QG.QPixmap( HydrusStaticDir.get_static_path( 'gallery_play.png' ) )
        
        self.highlight = QG.QPixmap( HydrusStaticDir.get_static_path( 'highlight.png' ) )
        self.clear_highlight = QG.QPixmap( HydrusStaticDir.get_static_path( 'clear_highlight.png' ) )
        
        self.lock = QG.QPixmap( HydrusStaticDir.get_static_path( 'lock.png' ) )
        self.lock_open = QG.QPixmap( HydrusStaticDir.get_static_path( 'lock_open.png' ) )
        
        self.star = QG.QPixmap( HydrusStaticDir.get_static_path( 'star.png' ) )
        
        #self.listctrl = QG.QPixmap( HydrusStaticDir.GetStaticPath( 'listctrl.png' ) )
        
        self.page_with_text = QG.QPixmap( HydrusStaticDir.get_static_path( 'page_with_text.png' ) )
        
        self.copy = QG.QPixmap( HydrusStaticDir.get_static_path( 'copy.png' ) )
        self.paste = QG.QPixmap( HydrusStaticDir.get_static_path( 'paste.png' ) )
        
        self.eight_chan = QG.QPixmap( HydrusStaticDir.get_static_path( '8chan.png' ) )
        
        self.pair = QG.QPixmap( HydrusStaticDir.get_static_path( 'pair.png' ) )
...
class GlobalIcons( object ):
    ...
    def _get_svg_or_png_path_icon( self, name ) -> QG.QIcon:
        
        return QG.QIcon( HydrusStaticDir.get_static_icon_path( name ) )
        
    
    def _reinitialise( self ):
        
        self.hydrus_frame = self._get_svg_or_png_path_icon( 'hydrus_32_non-transparent' )
        self.hydrus_system_tray = self._get_svg_or_png_path_icon( 'hydrus_non-transparent' )
        
        self.bold = self._get_svg_or_png_path_icon( 'text_bold' )
        self.italic = self._get_svg_or_png_path_icon( 'text_italic' )
        self.underline = self._get_svg_or_png_path_icon( 'text_underline' )
        
        self.align_left = self._get_svg_or_png_path_icon( 'text_align_left' )
        self.align_center = self._get_svg_or_png_path_icon( 'text_align_center' )
        self.align_right = self._get_svg_or_png_path_icon( 'text_align_right' )
        self.align_justify = self._get_svg_or_png_path_icon( 'text_align_justify' )
        
        self.indent_less = self._get_svg_or_png_path_icon( 'text_indent_remove' )
        self.indent_more = self._get_svg_or_png_path_icon( 'text_indent' )
        
        self.font = self._get_svg_or_png_path_icon( 'font' )
        self.colour = self._get_svg_or_png_path_icon( 'color_swatch' )
        
        self.link = self._get_svg_or_png_path_icon( 'link' )
        self.link_break = self._get_svg_or_png_path_icon( 'link_break' )
        
        self.drag = self._get_svg_or_png_path_icon( 'drag' )
        
        self.transparent = self._get_svg_or_png_path_icon( 'transparent' )
        self.downloading = self._get_svg_or_png_path_icon( 'downloading' )
        self.file_repository = self._get_svg_or_png_path_icon( 'file_repository_small' )
        self.file_repository_pending = self._get_svg_or_png_path_icon( 'file_repository_pending_small' )
        self.file_repository_petitioned = self._get_svg_or_png_path_icon( 'file_repository_petitioned_small' )
        self.ipfs = self._get_svg_or_png_path_icon( 'ipfs_small' )
        self.ipfs_pending = self._get_svg_or_png_path_icon( 'ipfs_pending_small' )
        self.ipfs_petitioned = self._get_svg_or_png_path_icon( 'ipfs_petitioned_small' )
        
        self.collection = self._get_svg_or_png_path_icon( 'collection' )
        self.inbox = self._get_svg_or_png_path_icon( 'inbox' )
        self.trash = self._get_svg_or_png_path_icon( 'trash' )
        
        self.refresh = self._get_svg_or_png_path_icon( 'refresh' )
        self.archive = self._get_svg_or_png_path_icon( 'archive' )
        self.to_inbox = self._get_svg_or_png_path_icon( 'to_inbox' )
        self.delete = self._get_svg_or_png_path_icon( 'trash' )
        self.trash_delete = self._get_svg_or_png_path_icon( 'delete' )
        self.undelete = self._get_svg_or_png_path_icon( 'undelete' )
        self.zoom_in = self._get_svg_or_png_path_icon( 'zoom_in' )
        self.zoom_out = self._get_svg_or_png_path_icon( 'zoom_out' )
        self.zoom_switch = self._get_svg_or_png_path_icon( 'zoom_switch' )
        self.zoom_cog = self._get_svg_or_png_path_icon( 'zoom_cog' )
        self.eye = self._get_svg_or_png_path_icon( 'eye' )
        self.eye_closed = self._get_svg_or_png_path_icon( 'eye_closed' )
        self.open_externally = self._get_svg_or_png_path_icon( 'open_externally' )
        self.move = self._get_svg_or_png_path_icon( 'move' )
        self.move_cursor = self._get_svg_or_png_path_icon( 'move32x' )
        
        self.dump_ok = self._get_svg_or_png_path_icon( 'dump_ok' )
        self.dump_recoverable = self._get_svg_or_png_path_icon( 'dump_recoverable' )
        self.dump_fail = self._get_svg_or_png_path_icon( 'dump_fail' )
        
        self.image = self._get_svg_or_png_path_icon( 'image' )
        self.images = self._get_svg_or_png_path_icon( 'images' )
        self.slideshow = self._get_svg_or_png_path_icon( 'slideshow' )
        
        self.family = self._get_svg_or_png_path_icon( 'family' )
        self.keyboard = self._get_svg_or_png_path_icon( 'keyboard' )
        self.help = self._get_svg_or_png_path_icon( 'help' )
        
        self.check = self._get_svg_or_png_path_icon( 'check' )
        self.pause = self._get_svg_or_png_path_icon( 'pause' )
        self.play = self._get_svg_or_png_path_icon( 'play' )
        self.stop = self._get_svg_or_png_path_icon( 'stop' )
        
        self.sound = self._get_svg_or_png_path_icon( 'sound' )
        self.mute = self._get_svg_or_png_path_icon( 'mute' )
        
        self.notes = self._get_svg_or_png_path_icon( 'notes' )
        
        self.file_pause = self._get_svg_or_png_path_icon( 'file_pause' )
        self.file_play = self._get_svg_or_png_path_icon( 'file_play' )
        self.gallery_pause = self._get_svg_or_png_path_icon( 'gallery_pause' )
        self.gallery_play = self._get_svg_or_png_path_icon( 'gallery_play' )
        
        self.highlight = self._get_svg_or_png_path_icon( 'highlight' )
        self.clear_highlight = self._get_svg_or_png_path_icon( 'clear_highlight' )
        
        self.lock = self._get_svg_or_png_path_icon( 'lock' )
        self.lock_open = self._get_svg_or_png_path_icon( 'lock_open' )
        
        #self.listctrl = self._GetSVGOrPNGPathIcon( 'listctrl' )
        
        self.page_with_text = self._get_svg_or_png_path_icon( 'page_with_text' )
        
        self.copy = self._get_svg_or_png_path_icon( 'copy' )
        self.paste = self._get_svg_or_png_path_icon( 'paste' )
        
        self.eight_chan = self._get_svg_or_png_path_icon( '8chan' )
        
        self.pair = self._get_svg_or_png_path_icon( 'pair' )
        
        self.hydrus_black_square = self._get_svg_or_png_path_icon( 'hydrus_black_square' )
        self.github = self._get_svg_or_png_path_icon( 'github' )
        self.x = self._get_svg_or_png_path_icon( 'x' )
        self.tumblr = self._get_svg_or_png_path_icon( 'tumblr' )
        self.discord = self._get_svg_or_png_path_icon( 'discord' )
        self.patreon = self._get_svg_or_png_path_icon( 'patreon' )
        
        # svgs I've done:
        
        self.cog = self._get_svg_or_png_path_icon( 'cog' )
        self.retry = self._get_svg_or_png_path_icon( 'retry' )
        self.star = self._get_svg_or_png_path_icon( 'star' )
        
        self.position_first = self._get_svg_or_png_path_icon( 'position_first' )
        self.position_previous = self._get_svg_or_png_path_icon( 'position_previous' )
        self.position_next = self._get_svg_or_png_path_icon( 'position_next' )
        self.position_last = self._get_svg_or_png_path_icon( 'position_last' )
        self.position_random = self._get_svg_or_png_path_icon( 'position_random' )
        
        self.fullscreen_switch = self._get_svg_or_png_path_icon( 'fullscreen_switch' )
        
        self.refresh_user_icons()
    ...
    def refresh_user_icons( self ):
        
        self.user_icons = {}
        
        for path in HydrusStaticDir.list_static_dir_file_paths( HC.USERPATH_SVG_ICON ):
