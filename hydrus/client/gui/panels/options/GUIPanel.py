...
class GUIPanel( ClientGUIOptionsPanelBase.OptionsPagePanel ):
    ...
    def __init__( self, parent ):
        ...
        self._options_search_bar_top_of_window = ClientGUICommon.BetterChoice( self._misc_panel )
        self._options_search_bar_top_of_window.setToolTip( ClientGUIFunctions.WrapToolTip( 'Relocate the built in options search bar. Requires applying and re-opening this dialog to update.' ) )
        
        self._options_search_bar_top_of_window.addItem( 'top of this window', True )
        self._options_search_bar_top_of_window.addItem( 'bottom of this window', False )
