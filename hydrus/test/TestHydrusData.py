...
class TestHydrusNumbers( unittest.TestCase ):
    ...
    def test_ordinals( self ):
        ...
        self.assertEqual(HydrusNumbers.int_to_pretty_ordinal_string(1), '1st')
        self.assertEqual(HydrusNumbers.int_to_pretty_ordinal_string(2), '2nd')
        self.assertEqual(HydrusNumbers.int_to_pretty_ordinal_string(3), '3rd')
        self.assertEqual(HydrusNumbers.int_to_pretty_ordinal_string(4), '4th')
        
        self.assertEqual(HydrusNumbers.int_to_pretty_ordinal_string(11), '11th')
        self.assertEqual(HydrusNumbers.int_to_pretty_ordinal_string(12), '12th')
        
        self.assertEqual(HydrusNumbers.int_to_pretty_ordinal_string(213), '213th')
        
        self.assertEqual(HydrusNumbers.int_to_pretty_ordinal_string(1011), '1,011th')
